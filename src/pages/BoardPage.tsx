...
import { Plus, Users, ArrowLeft, Loader2, X, Search, RotateCcw, Download, ChevronDown, FileSpreadsheet, FileText, LayoutGrid, BarChart3 } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col bg-neutral-50">
      ...
      <header className="bg-white border-b border-neutral-200 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* View Toggle Tabs */}
          <div className="ml-4 flex items-center gap-1 bg-neutral-100 p-1 rounded-lg border border-neutral-200 select-none">
            <button
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Main Content Area: Board View or Analytics Dashboard View */}
